        ...
        <div className="mx-auto max-w-md">
          <div className="rounded-lg bg-white p-6 shadow">
            <h1 className="mb-4 text-xl font-semibold text-red-600">
              {config.thankyou?.errorTitle || "Order Not Found"}
            </h1>
            <p className="mb-4 text-gray-600">
              {error?.message ||
                config.thankyou?.errorDescription ||
            ...
            >
              {config.thankyou?.backToCheckoutLabel || "Return to Checkout"}
            </LinkButton>
          </div>
        </div>
      </div>
        ...
        <div className="mb-12 text-center">
          <div className="mb-6">
            ...
            <h1 className="mb-2 text-4xl font-bold text-slate-900">
              {config.thankyou?.title || "Thank You for Your Order!"}
            </h1>
            <p className="text-xl text-slate-600">
              {config.thankyou?.subtitle || "Your order has been confirmed"}
            </p>
          </div>
          ...
          <Card className="shadow-lg">
            <CardHeader>
              <CardTitle className="flex items-center space-x-2">
                ...
                <span>
                  {config.thankyou?.itemsOrderedTitle || "Items Ordered"}
                </span>
              </CardTitle>
            </CardHeader>
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      {item.amount - item.adjustedAmount > 0 && (
                        ...
                        >
                          <>
                            {config.thankyou?.savePrefix || "Save"}{" "}
        ...
        <footer className="mt-12 space-y-4 text-center text-sm text-slate-600">
          <div className="flex justify-center space-x-4">
            <a href="#" className="hover:text-slate-900">
              {config.footer?.termsLabel || "Terms & Conditions"}
            </a>
            <span>|</span>
            <a href="#" className="hover:text-slate-900">
              {config.footer?.privacyLabel || "Privacy Policy"}
            </a>
            <span>|</span>
            <a href="#" className="hover:text-slate-900">
              {config.footer?.returnsLabel || "Returns"}
            </a>
          </div>
          <p>
            {config.footer?.copyright || "© 2024 Tagada. All rights reserved."}
          </p>
        </footer>
      </div>
    </div>
